    ...
    var game = {
        ...
        goNextPhase: function () {
            ...
            case this.PHASE_GAME_OVER:
                ...
                }else if (game.players[0].fleet[0].life === 0 && game.players[0].fleet[1].life === 0 && game.players[0].fleet[2].life === 0 && game.players[0].fleet[3].life === 0)
                {
                    utils.info("Bien jouer !");
                    setTimeout(() => {
                        location.reload();
                    }, 10);
        ...
        fire: function (from, col, line, callback) {
            ...
            var sonToucher = new Audio("snd/toucher.wav");
            var sonManquer = new Audio("snd/rate.wav");
            var sonTirer = new Audio("snd/fire_00.wav");
            var spalsh = new Audio("snd/Splash.wav");
        ...
        target.receiveAttack(col, line, function (hasSucceed) {
            ...
            if (game.currentPhase === game.PHASE_PLAY_PLAYER) {
                ...
                if (cell.style.backgroundImage == "") {
                    if (hasSucceed) {
                        ...
                        cell.style.backgroundImage = "url('img/splash.png')";
                        cell.style.backgroundRepeat = "no-repeat";
                        cell.style.backgroundSize = "cover";
                        sonManquer.play();
                        setTimeout(() => {
            ...
            if (game.currentPhase === game.PHASE_PLAY_OPPONENT){
                ...
                var positionShips = game.players[0].grid[line][col];
                    ...
                    if (hasSucceed) {
                        ...
                        cellOponent.style.backgroundImage = "url('img/boom.png')";
                        cellOponent.style.backgroundRepeat = "no-repeat";
                        cellOponent.style.backgroundSize = "cover";
                        setTimeout(() => {
                            
                        }, 1000);
                    } else {
                        
                        cellOponent.style.backgroundImage = "url('img/splash.png')";
                        cellOponent.style.backgroundRepeat = "no-repeat";
                        cellOponent.style.backgroundSize = "cover";
                        sonManquer.play();
                        setTimeout(() => {
